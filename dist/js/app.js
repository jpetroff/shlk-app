...
var HistoryWidget = function (_a) {
    var _b;
    var list = _a.list, totalCount = _a.totalCount, isLoading = _a.isLoading, display = _a.display;
                ...
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(globalClass, "__shortlink-block ").concat(mobileConvenienceClass) },
                    ...
                    !this.state.showSnoozeOptions && (react__WEBPACK_IMPORTED_MODULE_1__.createElement(react__WEBPACK_IMPORTED_MODULE_1__.Fragment, null,
                        ...
                        this.state.generatedShortlink &&
                            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_shortlink_slug_input__WEBPACK_IMPORTED_MODULE_12__["default"], { displayLink: _js_link_tools__WEBPACK_IMPORTED_MODULE_3__["default"].displayServiceUrl, userTag: ((_b = (_a = this.props.context) === null || _a === void 0 ? void 0 : _a.user) === null || _b === void 0 ? void 0 : _b.userTag) ? (_d = (_c = this.props.context) === null || _c === void 0 ? void 0 : _c.user) === null || _d === void 0 ? void 0 : _d.userTag : 'someone', value: this.state.descriptionTag, placeholder: "your-custom-url", onChange: this.handleDescriptorChange, show: this.state.generatedShortlink ? true : false, generatedLink: this.state.generatedDescriptiveShortlink, isLoading: this.state.loadingState.createDescriptiveLinkIsLoading, hasCta: !this.state.generatedDescriptiveShortlink || this.state.generatedDescriptiveShortlink != '', error: this.state.errorState.createDescriptiveLinkResult, flyover: react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(globalClass, "__flyover") },
...
/* harmony import */ var _components_shortlink_list_item__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../../components/shortlink-list-item */ "./src/components/shortlink-list-item/index.tsx");
...
/* harmony import */ var _components_radio_group__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../components/radio-group */ "./src/components/radio-group/index.tsx");
/* harmony import */ var _components_dropdown_menu__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../../components/dropdown-menu */ "./src/components/dropdown-menu/index.tsx");
/* harmony import */ var _components_menu_item__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../components/menu-item */ "./src/components/menu-item/index.tsx");
/* harmony import */ var _components_scroller__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../../components/scroller */ "./src/components/scroller/index.tsx");
/* harmony import */ var _js_clipboard_tools__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../js/clipboard.tools */ "./src/js/clipboard.tools.ts");
/* harmony import */ var _js_link_tools__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../js/link.tools */ "./src/js/link.tools.ts");
/* harmony import */ var _components_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../components/icons */ "./src/components/icons/index.tsx");
/* harmony import */ var _UrlEdit__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../UrlEdit */ "./src/apps/UrlEdit/index.tsx");
/* harmony import */ var _components_snackbar__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../components/snackbar */ "./src/components/snackbar/index.tsx");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var ShortlinkList = /** @class */ (function (_super) {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        underscore__WEBPACK_IMPORTED_MODULE_2__.defer(function () {
                            console.log(load);
                            console.log(_this.state.shortlinks);
                        });
                        return [2 /*return*/];
                }
            });
    ...
    ShortlinkList.prototype.groupShortlinks = function (shortlinks) {
        ...
        var _enrichedLabelGroups = _js_datetime_tools__WEBPACK_IMPORTED_MODULE_5__["default"].groupDatedItems(shortlinks, dateGroupKey);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = (_a = this.state.shortlinks[this.state.contextMenu.key]) === null || _a === void 0 ? void 0 : _a._id;
                        return [4 /*yield*/, _js_shortlink_gql__WEBPACK_IMPORTED_MODULE_4__["default"].deleteShortlink(id)];
                    case 1:
                        result = _b.sent();
                        console.log(result);
    ...
    ShortlinkList.prototype.handleCopyClick = function (key) {
        ...
        var shortlink = this.state.shortlinks[key].descriptor ?
            _js_link_tools__WEBPACK_IMPORTED_MODULE_6__["default"].generateDescriptiveShortlink(this.state.shortlinks[key].descriptor) :
            _js_link_tools__WEBPACK_IMPORTED_MODULE_6__["default"].generateShortlinkFromHash(this.state.shortlinks[key].hash);
        _js_clipboard_tools__WEBPACK_IMPORTED_MODULE_7__["default"].copy(shortlink);
    };
    ...
    ShortlinkList.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(listClasses) },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(globalClass, "__search") },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_input__WEBPACK_IMPORTED_MODULE_8__["default"], { onChange: this.onSearchQueryChange, onDebouncedChange: this.onSearch, value: this.state.searchQuery, placeholder: 'Search your links', rightIcon: _components_icons__WEBPACK_IMPORTED_MODULE_9__.Search }),
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_radio_group__WEBPACK_IMPORTED_MODULE_10__["default"], { items: [
            ...
            react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_scroller__WEBPACK_IMPORTED_MODULE_11__["default"], { className: "".concat(globalClass, "__scroller"), onScroll: this.handleScroll },
                react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(globalClass, "__list") },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_dropdown_menu__WEBPACK_IMPORTED_MODULE_13__["default"], { divRef: this.contextMenuRef, show: this.state.contextMenu.show, onClose: this.resetContextMenu, onEnter: this.handleContextPortal, style: { top: this.state.contextMenu.top, left: this.state.contextMenu.left } },
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_menu_item__WEBPACK_IMPORTED_MODULE_14__["default"], { label: 'Delete', onClick: this.handleDeleteShortlink }),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_menu_item__WEBPACK_IMPORTED_MODULE_14__["default"].Separator, null),
                        this.getSubsection() == ShortlinkListSubsection.snoozed && react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_menu_item__WEBPACK_IMPORTED_MODULE_14__["default"], { label: 'Remove snooze', onClick: this.handleRemoveSnoozeTimer }),
                        react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_menu_item__WEBPACK_IMPORTED_MODULE_14__["default"], { label: 'Edit shortlink', onClick: this.handleSelectShortlink })))),
            this.state.selected.shortlink &&
                react__WEBPACK_IMPORTED_MODULE_1__.createElement(_UrlEdit__WEBPACK_IMPORTED_MODULE_15__["default"], { onChange: this.handleUrlChange, onCancel: this._clearSelected, shortlink: this.state.selected.shortlink, isLoading: this.state.selected.loading, userContextName: this.props.context.user.userTag }),
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(globalClass, "__snackbar-container") },
                this.state.selected.errorState &&
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_snackbar__WEBPACK_IMPORTED_MODULE_16__["default"], { className: "".concat(globalClass, "__shortlink-list-error"), message: this.state.selected.errorState, canDismiss: true, onDismiss: this._clearSelectedErrorState }),
                this.state.selected.successState &&
                    react__WEBPACK_IMPORTED_MODULE_1__.createElement(_components_snackbar__WEBPACK_IMPORTED_MODULE_16__["default"], { className: "".concat(globalClass, "__shortlink-list-success"), message: this.state.selected.successState, canDismiss: true, timer: 2000, onDismiss: this._clearSelectedSuccessState }))));
    };
...
var ShortlinkListItem = function (_a) {
    var _b;
    var location = _a.location, hash = _a.hash, descriptor = _a.descriptor, timestamp = _a.timestamp, siteTitle = _a.siteTitle, siteDescription = _a.siteDescription, urlMetadata = _a.urlMetadata, snooze = _a.snooze, tags = _a.tags, onContextClick = _a.onContextClick, onCopyClick = _a.onCopyClick;
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(shortlinkItemClasses) },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement(_link__WEBPACK_IMPORTED_MODULE_5__["default"], { className: "".concat(globalClass, "__display-full-link ").concat(noDescription), href: location, colorScheme: _link__WEBPACK_IMPORTED_MODULE_5__.LinkColors.USER },
            react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(globalClass, "__display-full-link__main") },
                ...
                siteDescription && react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "".concat(globalClass, "__display-full-link__description") }, siteDescription)),
...
var ShortlinkSlugInput = function (_a) {
    var _b;
    var onChange = _a.onChange, show = _a.show, isLoading = _a.isLoading, generatedLink = _a.generatedLink, hasCta = _a.hasCta, error = _a.error, displayLink = _a.displayLink, userTag = _a.userTag, value = _a.value, placeholder = _a.placeholder, flyover = _a.flyover;
            ...
            react__WEBPACK_IMPORTED_MODULE_2__.createElement("div", { className: "".concat(globalClass, "__action-wrapper ").concat(activeActionWrapperClass), onClick: handleCopy },
                react__WEBPACK_IMPORTED_MODULE_2__.createElement("div", { className: "".concat(globalClass, "__constructed-input") },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_2__.createElement("span", { className: "".concat(globalClass, "__input-resizable") },
                        react__WEBPACK_IMPORTED_MODULE_2__.createElement("input", { className: "".concat(globalClass, "__input-resizable__real-input ").concat(globalClass, "__input-common-style"), value: value, onChange: function (event) { onChange(event.target.value); } }),
