...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _browser_api__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./browser-api */ "./src/js/browser-api.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
__webpack_require__.g.sendActiveTabUrl = function sendActiveTabUrl() {
    return __awaiter(this, void 0, void 0, function () {
        var activeTab, response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _browser_api__WEBPACK_IMPORTED_MODULE_0__["default"].getTab(true)];
                case 1:
                    activeTab = _a.sent();
                    return [4 /*yield*/, _browser_api__WEBPACK_IMPORTED_MODULE_0__["default"].sendMessage({ activeUrl: activeTab === null || activeTab === void 0 ? void 0 : activeTab.url })];
                case 2:
                    response = _a.sent();
