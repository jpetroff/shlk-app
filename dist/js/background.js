...
/* harmony import */ var _browser_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./browser.api */ "./src/js/browser.api.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
function resetAlarms(links) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, _browser_api__WEBPACK_IMPORTED_MODULE_1__["default"].getAlarms()];
                case 1:
                    alarms = _a.sent();
                    ...
                    checkAlarms.forEach(function (alarmName) {
                        if (alarmName != 'syncSnoozedTabs' && indexAlarms[alarmName] != undefined)
                            _browser_api__WEBPACK_IMPORTED_MODULE_1__["default"].removeAlarm(alarmName);
                    });
                    return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    _browser_api__WEBPACK_IMPORTED_MODULE_1__["default"].setAlarm('syncSnoozedTabs', {
